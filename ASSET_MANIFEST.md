...
| Comic page 02 | `src/assets/legends/christian-chukwu/comic/comic-page-02.png` | NEEDS CLEANUP | Future Comic Reader | Supplied concept artwork; embedded text should not be treated as verified site copy. |
...
| Comic page 06 | `src/assets/legends/christian-chukwu/comic/comic-page-06.png` | NEEDS CLEANUP | Future Comic Reader | Supplied concept artwork; embedded text should not be treated as verified site copy. |
...
| Comic page 08 | `src/assets/legends/christian-chukwu/comic/comic-page-08.png` | NEEDS CLEANUP | Future Comic Reader | Supplied concept artwork; embedded text should not be treated as verified site copy. |
...
| Chairman graphic 01, optimized Home derivative | `src/assets/legends/christian-chukwu/optimized/graphics/graphic-chairman-01-home.png` | NEEDS CLEANUP | Home Hero, Home Featured Legend | Non-destructive resized PNG derivative for Home use. |
...
| Champions graphic 03, optimized Home derivative | `src/assets/legends/christian-chukwu/optimized/story/graphic-champions-03-home.png` | NEEDS CLEANUP | Home Story Preview | Non-destructive resized PNG derivative for Home use. |
...
| Collection hero main, optimized Home derivative | `src/assets/legends/christian-chukwu/optimized/collection/collection-hero-main-home.png` | NEEDS CLEANUP | Home Collection 001 Hero | Non-destructive resized PNG derivative for Home use. |
